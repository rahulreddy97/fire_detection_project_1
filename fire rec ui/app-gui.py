...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            button2 = tk.Button(self, text="   Start Detecting  ", fg="#ffffff", bg="#263942",command=self.model)
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        tk.Label(self, text="Enter the name", fg="#263947", font='Helvetica 12 bold').grid(row=0, column=0, pady=10, padx=5)
        tk.Label(self, text="Enter Mobile Number", fg="#263942", font='Helvetica 12 bold').grid(row=1, column=0, pady=10, padx=5)
        ...
        self.user_phone.grid(row=1, column=1, pady=10, padx=10)
        self.buttoncanc = tk.Button(self, text="Cancel", bg="#ffffff", fg="#263942", command=lambda: controller.show_frame("StartPage"))
        self.buttonext = tk.Button(self, text="Add", fg="#ffffff", bg="#263942", command=self.save_user)
...
#         label = tk.Label(self, text="Fire Detection", font='Helvetica 16 bold')
#         label.grid(row=0,column=0, sticky="ew")
#         button1 = tk.Button(self, text="Fire Detection", command=self.openwebcam, fg="#ffffff", bg="#263942")
